...
def pairs_trading_algo(self):
    ...
    api = tradeapi.REST('pubKey', 'secKey', api_version='v2') # or use ENV Vars shown below
    account = api.get_account()
    
    #The mail addresses and password
    sender_address = 'nishiketsingh.0@gmail.com'
    sender_pass = '**********'
    receiver_address = 'nishiketsingh.1@gmail.com'
    #Setup the MIME
